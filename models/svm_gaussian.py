...
create_svm_gaussian_model("hold_out", "hu")
create_svm_gaussian_model("10_cross", "hu")
create_svm_gaussian_model("hold_out", "zernike")
create_svm_gaussian_model("10_cross", "zernike")