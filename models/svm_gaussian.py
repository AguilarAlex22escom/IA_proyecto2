...
def create_svm_gaussian_model(split, moment):
    print("Working with Support Vector Machine (Gaussian kernel)...")
    ...
    if split == "hold_out": 
        ...
        return {"Model" : "SVM Gaussian", "Split method": "Hold out", "Accuracy" : accuracy.round(4), "Moments" : moment}
        ...
        return {"Model" : "SVM Gaussian", "Split method": "5-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
        ...
        average_area = np.mean(areas)
        make_printers(average_accuracy, split, moment, average_matrix, average_area)
        return {"Model" : "SVM Gaussian", "Split method": "10-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
    else:
