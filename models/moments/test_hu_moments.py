...
def create_test_dataset_hu(path): # This function gets the directory path with the sorted shapes
    ...
    for image_file in images: # Iterate the get shapes of directory
        ...
        ret, thresh = cv.threshold(gray,0,127,cv.THRESH_BINARY) # Binarize the image to only have 0's and 255's
    ...
    return hu_dataset
# create_test_dataset_hu("shapes/test_dataset/")