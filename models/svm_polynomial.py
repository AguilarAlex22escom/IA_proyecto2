...
def create_svm_polynomial_model(split, moment):
    ...
    if split == "hold_out": 
        ...
        return {"Model" : "SVM Polynomial", "Split method": "Hold out", "Accuracy" : accuracy.round(4), "Moments" : moment}
        ...
        return {"Model" : "SVM Polynomial", "Split method": "5-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
        ...
        average_area = np.mean(areas)
        make_printers(average_accuracy, split, moment, average_matrix, average_area)
        return {"Model" : "SVM Polynomial", "Split method": "10-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
    else:
