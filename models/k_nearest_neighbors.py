...
def create_nearest_neighbors_model(split, moment):
    print("Working with K Nearest Neighbors model (10 neighbors)...")
    ...
    if split == "hold_out": 
        ...
        model = knn.fit(x_train_scaled, y_train_hd)
        ...
        return {"Model" : "K nearest neighbors", "Split method": "Hold out", "Accuracy" : accuracy.round(4), "Moments" : moment}
        ...
        for train_index, test_index in skf.split(x_train, y_train):
            ...
            model = knn.fit(x_train_scaled, y_train_skf)
            y_pred = model.predict(x_test_scaled)
        ...
        return {"Model" : "K nearest neighbors", "Split method": "5-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
        ...
        average_area = np.mean(areas)
        make_printers(average_accuracy, split, moment, average_matrix, average_area)
        return {"Model" : "K nearest neighbors", "Split method": "10-Fold cross", "Accuracy" : average_accuracy.round(4), "Moments" : moment}
    else:
