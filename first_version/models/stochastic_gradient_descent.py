...
create_stochastic_gradient_descent_model("hold_out", "hu")
create_stochastic_gradient_descent_model("hold_out", "zernike")
create_stochastic_gradient_descent_model("10_cross", "hu")
create_stochastic_gradient_descent_model("10_cross", "zernike")