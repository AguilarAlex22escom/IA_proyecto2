...
def create_naive_bayes_model(split, moment):
...
create_naive_bayes_model("hold_out", "hu")
create_naive_bayes_model("hold_out", "zernike")
create_naive_bayes_model("10_cross", "hu")
create_naive_bayes_model("10_cross", "zernike")