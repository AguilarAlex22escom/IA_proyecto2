...
def create_nearest_neighbor_model(split, moment):
    ...
    if split == "hold_out": 
        ...
        model = neigh.fit(x_train_scaled, y_train)
...
create_nearest_neighbor_model("hold_out", "hu")
create_nearest_neighbor_model("10_cross", "hu")
create_nearest_neighbor_model("hold_out", "zernike")
create_nearest_neighbor_model("10_cross", "zernike")