...
create_nearest_neighbors_model("hold_out", "hu")
create_nearest_neighbors_model("10_cross", "hu")
create_nearest_neighbors_model("hold_out", "zernike")
create_nearest_neighbors_model("10_cross", "zernike")