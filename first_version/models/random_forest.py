...
create_random_forest_model("hold_out", "hu")
create_random_forest_model("10_cross", "hu")
create_random_forest_model("hold_out", "zernike")
create_random_forest_model("10_cross", "zernike")